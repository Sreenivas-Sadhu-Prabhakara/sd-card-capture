package com.bank.bian.cardcapture.model;
...
/**
 * The BIAN control record for this service domain: "Captured Card Procedure".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Process) applied
 * to its asset type (Captured Card). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Captured Card Procedure";
